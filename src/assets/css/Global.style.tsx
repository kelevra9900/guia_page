...
const GlobalStyle = createGlobalStyle`
  ...
  button.modalCloseBtn {
    ...
    &.alt {
      ...
      background-color: ${themeGet('colors.primary', '#0f3d72')} !important;
  ...
  .reuseModalHolder.login-modal{
    .reusecore__button {
      ...
      &.default {
        color: ${themeGet('colors.heading', '#191919')};
        background-color: ${themeGet('colors.primary', '#0f3d72')};
        &:hover {
          box-shadow: none;
        }
      }
...
const InteriorWrapper = styled.div`
  ...
  .read_more__btn {
    display: inline-flex;
    align-items: center;
    color: ${themeGet('colors.heading3', '#1c4374')};
    font-size: 12px;
    font-weight: 700;
    text-transform: uppercase;
    position: relative;
...
const AvisoSectionWrapper = styled.div`
  overflow: hidden;
  padding: 0 0 32px;
  margin: 48px auto 0;
  margin-top: 80px;
  ...
  box-shadow: 0 0 20px rgba(0, 0, 0, 0.02), 0 0px 40px rgba(0, 0, 0, 0.02);
  border-radius: 5px;
`;

const ListaSection = styled.ol`
...
const AvisoSectionHeader = styled.header`
  padding-top: 32px;
  text-align: center;
  h1 {
    font-size: 25px;
...
const AvisoSectionBody = styled.div`
  padding-bottom: 10px;
  text-align: center;
  h2 {
    font-size: 18px;
...
const ContentAvisoWrapper = styled.div`
  flex: 1 0 auto;
  width: 100%;
  overflow: hidden;
`;
